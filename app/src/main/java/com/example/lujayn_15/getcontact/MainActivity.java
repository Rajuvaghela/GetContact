package com.example.lujayn_15.getcontact;
...
public class MainActivity extends AppCompatActivity {
                ...
                if (dataCursor.moveToFirst()) {
                    ...
                    do {
                        if (dataCursor
                            ...
                            contactOtherDetails +=  nickName;// Add the nick name to string
                            printLog("NickName",""+nickName);
                        }
                        ...
                        if (dataCursor
                            ...
                            switch (dataCursor.getInt(dataCursor
                                ...
                                case ContactsContract.CommonDataKinds.Phone.TYPE_MOBILE:
                                    ...
                                    printLog("Mobile Phone ",""+mobilePhone);
                                    break;
    ...
    public  void printLog(String name,String des){
